...
export const commentsData: CommentData[] = [
  {
    ...
    comment: 'Thank you for taking the time to make the work',
    isYouTuber: true,
  },
  {
    username: 'LUFFY',
  ...
  },
  {
    ...
    comment:
      "From the thumbnail it looks like you're missing rainbow-delimiters.but other than that, looks pretty much exactly the same (within reason) as vscode",
    isYouTuber: true,
  },
  {
  ...
  },
  {
    ...
    comment: 'Best Working Experience',
    isYouTuber: true,
  },
];
